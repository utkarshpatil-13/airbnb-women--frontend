    ...
    return (
        ...
        <header className='p-4 flex justify-between'>
          <Link to={'/'} className='flex items-center gap-1'>
            ...
            <div className='flex rounded-full shadow-gray-500 shadow-sm py-2 px-4 gap-2'>
              <div>Anywhere</div>
            ...
            <div className='flex rounded-full shadow-gray-500 shadow-sm py-2 px-4 gap-2 items-center'>
